...
public class UniStorageModule extends AbstractInMemoryRelationStorage<Module> implements ModuleOfUniversityDao {
    ...
    @Override
    public CollectionModelResult<Module> readByModuleName(long primaryId, String name_of_module, SearchParameter searchParameter) {
        return InMemoryPaging.page(
                this.readAllLinkedByPredicate(primaryId, (p) -> name_of_module.isEmpty() || p.getModuleName().equals(name_of_module)),
